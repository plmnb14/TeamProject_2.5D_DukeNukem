...
HRESULT CMonsterBullet::LateInit()
{
...
HRESULT CMonsterBullet::AddComponent()
{
	ENGINE::CComponent* pComponent = nullptr;

	// Texture
	pComponent = m_pResourceMgr->CloneResource(ENGINE::RESOURCE_STATIC, L"Monster_Bullet");
...
void CMonsterBullet::KeyInput()
{

}

void CMonsterBullet::BulletType()
{
	switch (m_eWeaponTag)
	{
	case ENGINE::RIFLE:
...
void CMonsterBullet::ChangeTex(wstring _wstrTex)
{
...
void CMonsterBullet::Set_Target(CGameObject * _Target)
{
	m_pTarget = _Target;
}

void CMonsterBullet::Set_Device(LPDIRECT3DDEVICE9 pGraphicDev)
{
	m_pGraphicDev = pGraphicDev;
}

void CMonsterBullet::Set_Pos(D3DXVECTOR3 _Pos)
{
	m_pTransform->SetPos(_Pos);
}

void CMonsterBullet::Set_Dir(D3DXVECTOR3 _Dir)
{
	m_pTransform->SetDir(_Dir);
}

void CMonsterBullet::Set_Angle(float * _Angle)
{
...
void CMonsterBullet::Set_Attack(float _Attack)
{
	m_pCondition->Set_Damage(_Attack);
}

CMonsterBullet* CMonsterBullet::Create(LPDIRECT3DDEVICE9 pGraphicDev, D3DXVECTOR3 _Pos, D3DXVECTOR3 _Dir, float* _Angle, float _Speed, ENGINE::WEAPON_TAG _WeaponTag, float _Attack)
{
