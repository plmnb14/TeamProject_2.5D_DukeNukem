...
void CManagement::Render()
{
	...
	CCollisionMgr::CollisionBomb_To_Other(MAP_OBJ(ENGINE::OBJECT_TYPE::VFX_HIT), MAP_OBJ(ENGINE::OBJECT_TYPE::MONSTER));
	CCollisionMgr::CollisionBomb_To_Other(MAP_OBJ(ENGINE::OBJECT_TYPE::VFX_HIT), MAP_OBJ(ENGINE::OBJECT_TYPE::PLAYER));
