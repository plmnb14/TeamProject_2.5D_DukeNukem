...
CWallCubeCol::CWallCubeCol(LPDIRECT3DDEVICE9 pGraphicDev)
	: CVIBuffer(pGraphicDev)
{
}

CWallCubeCol::~CWallCubeCol()
{
	Release();
}

HRESULT CWallCubeCol::CreateBuffer()
{
...
void CWallCubeCol::Render()
{
	CVIBuffer::Render();
}

void CWallCubeCol::Release()
{
}

CWallCubeCol* CWallCubeCol::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	NULL_CHECK_RETURN(pGraphicDev, nullptr);

	CWallCubeCol* pInstance = new CWallCubeCol(pGraphicDev);
